<div class="container mt-4">
    ...
    <p class="mb-2">&copy; {{ date('Y') }} ByteCarlos. Todos os direitos reservados.</p>

    <!-- Logos das tecnologias utilizadas -->
    <p class="mb-2 mt-4">Tecnologias Utilizadas:</p>
    <div class="d-flex justify-content-center gap-4">
        <img src="{{ asset('images/laravel-logo.png') }}" alt="Laravel" class="footer-logo mx-2">
